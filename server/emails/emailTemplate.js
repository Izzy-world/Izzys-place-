export function resetPasswordEmailTemplate(firstName, resetUrl){
  ...
  <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    <div style="background: linear-gradient(to right, #3439ca, #00A0DC); padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
          <img src="https://res.cloudinary.com/eguono/image/upload/v1728864403/hr-manager/nav-logo_wzlhdy.png" alt="Eggys-place Logo" style=""max-width: 50.3px; max-height: 43.92px;" margin-bottom: 20px;border-radius: 10px;">
